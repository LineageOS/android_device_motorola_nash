 ...
 */
static uint32_t BRIGHTNESS_RAMP[RAMP_STEPS] = {0, 12, 25, 37, 50, 72, 85, 100};
...
static inline uint32_t rgbToBrightness(const LightState& state) {
